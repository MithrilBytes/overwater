"""From neilzhangpro/FengShuiAgents, src/Emotion.py, as written. The model
is the constructor default; src/Agents.py passes the same id in. The
prompt is Chinese in the original and is kept that way."""
