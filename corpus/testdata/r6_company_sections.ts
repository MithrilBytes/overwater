// From exa-labs/company-researcher, app/api/companysummary/route.ts. The
// model literal is the repository's own. The route takes the scraped main
// page and subpages of a company site and returns short headed sections
// about the company through a zod schema; the schema only shapes the JSON,
// every field in it is prose the model writes.
