"""Pulling the same four fields out of correspondence, inbound fax.

This module and its mail twin were copied from one another when the
mail intake was added, and neither author knew about the other. Both
